...
import { GET_CHILDREN_METHOD } from '../typedef/iq/device/manager/GetChildren';
...
import { GetChildrenCodec } from './iq/device/manager/GetChildrenCodec';
...
import { REMOVE_CHILD_METHOD } from '../typedef/iq/device/manager/RemoveChild';
import { RemoveChildCodec } from './iq/device/manager/RemoveChildCodec';
import { TOPIC_OWNER } from '../typedef/message/owner/OwnerMessage';
import { OwnerMessageCodec } from './message/device/OwnerMessageCodec';
import {GET_SHADOW_METHOD} from "../typedef/iq/device/manager/GetShadow";
import {GetShadowCodec} from "./iq/device/manager/GetShadowCodec";
import {GET_OWNERS_METHOD} from "../typedef/iq/owner/manager/GetOwners";
import {REMOVE_OWNER_METHOD} from "../typedef/iq/owner/manager/RemoveOwner";
import {OWNERSHIP_TAKEN_METHOD} from "../typedef/iq/owner/notify/OwnershipTaken";
import {OWNERSHIP_DISCLAIMED_METHOD} from "../typedef/iq/owner/notify/OwnershipDisclaimed";
import {GetOwnersCodec} from "./iq/owner/manager/GetOwnersCodec";
import {RemoveOwnerCodec} from "./iq/owner/manager/RemoveOwnerCodec";
import {OwnershipTakenCodec} from "./iq/owner/notify/OwnershipTakenCodec";
import {OwnershipDisclaimedCodec} from "./iq/owner/notify/OwnershipDisclaimedCodec";

export class StanzaCodec {

  iqCodecs: Map<String, IQCodec> = new Map<String, IQCodec>();
  messageCodecs: Map<String, MessageCodec<any>> = new Map<String, MessageCodec<any>>();
  ...
  constructor() {
    ...
    this.iqCodecs.set(GET_SHADOW_METHOD, new GetShadowCodec());
    ...
    this.iqCodecs.set(GET_OWNERS_METHOD, new GetOwnersCodec());
    this.iqCodecs.set(REMOVE_OWNER_METHOD, new RemoveOwnerCodec());
    this.iqCodecs.set(OWNERSHIP_TAKEN_METHOD, new OwnershipTakenCodec());
    this.iqCodecs.set(OWNERSHIP_DISCLAIMED_METHOD, new OwnershipDisclaimedCodec());
