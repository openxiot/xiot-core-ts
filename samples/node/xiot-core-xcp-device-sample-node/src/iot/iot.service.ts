import { XcpDeviceLTSKGetterImpl } from './XcpDeviceLTSKGetterImpl'
import {
  XcpFrameCodecType,
  XcpDeviceClient,
...
export class IotService {
  ...
  constructor(
    ...
    const getter = new XcpDeviceLTSKGetterImpl(deviceSeed, deviceLTPK, deviceLTSK)
    const cipher = new XcpDeviceClientCipherProductImpl(deviceType, getter, serverLTPK)
    const codec = XcpFrameCodecType.NOT_CRYPT
    this.client = new XcpDeviceClientImpl(serialNumber, productId, deviceType, cipher, codec)
